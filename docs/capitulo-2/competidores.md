...
<table>
    ...
    <tr>
        ...
        <td>
            <strong>ANITEC</strong><br>
                <img src="../../assets/images/competitors/anitec.png" alt="Logo de ANITEC" width="120">
        </td>
        <td>
            <strong>Livestock Manager</strong><br>
            <img src="../../assets/images/competitors/livestock-manager.png" alt="Logo de Livestock Manager" width="120">
        </td>
        <td>
            <strong>Herdwatch</strong><br>
            <img src="../../assets/images/competitors/herdwatch.png" alt="Logo de Herdwatch" width="120">
        </td>
        <td>
            <strong>AgriWebb</strong><br>
            <img src="../../assets/images/competitors/agriwebb.png" alt="Logo de AgriWebb" width="120">
        </td>
    </tr>
    <tr>
